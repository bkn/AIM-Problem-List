...
Then /^I should be redirected to (.*)$/ do |url|
  webrat_session.redirected_to.should =~ /#{url}/m
end
...
When /^I follow "(.*)" with method (.*)$/ do |link, method|
  click_link(link, :method => method.downcase.to_sym)
end
...
Then /^I should not see "(.*)"$/ do |text|
  response_body.should_not =~ /#{Regexp.escape(text)}/m
end
